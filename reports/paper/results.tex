...
\indent{The classificator result is shown in Table \ref{table:metrics}. The worst classification we received at Black-grass class. This is due to the fact that this type of plant is difficult to segmentation like a Loose Silky-bent (Fig. \ref{fig:seg_degradation}), which result is significantly better due to the presence of a purple root}. \\
