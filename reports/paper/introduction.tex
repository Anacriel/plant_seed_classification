...
\indent{ The remainder of the paper is as follows. In Section 2, the data used is described, and the methods of classification are considered. In Section 3, the classification results are given. In Section 4, some conclusions are drawn.}
