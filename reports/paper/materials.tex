...
\indent{We will be analyzing the contours bounding maximal areas:}
...
\indent{One of the methods to estimate rectangularity is to plot minimum bounding rectangle. Rectangularity is the ratio of the entire obect area to the minimum bounding rectangle area. This featere represent how rectangular an object is:}
